...
def config_mlflow():
    ...
    os.environ['MLFLOW_TRACKING_PASSWORD'] = 'dde6cf292052d838446b1a3bb55725c02c0735c9'
    mlflow.set_tracking_uri('https://dagshub.com/renansantosmendes/mlops-arda-t1.mlflow')
